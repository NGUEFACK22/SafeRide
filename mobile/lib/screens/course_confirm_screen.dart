...
class _CourseConfirmScreenState extends State<CourseConfirmScreen> {
  ...
  Future<void> _confirm() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Course acceptée — protection vocale active des deux côtés',
          ),
  ...
  Future<void> _cancel() async {
    if (_cancelling || _navigatedAway) return;
    _navigatedAway = true;
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text(
          'Demande annulée. Vous pouvez scanner un autre véhicule.',
        ),
      ),
    );
      ...
      case 'ANNULE':
        ...
        if (!_navigatedAway) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text(
                'Le transporteur a refusé la course. Vous pouvez scanner un autre véhicule.',
              ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Le transporteur doit confirmer qu\'il accepte la course.\nDès son accord, vous pourrez définir votre destination.',
                  textAlign: TextAlign.center,
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            fullName.isEmpty ? 'Transporteur' : fullName,
                            style: const TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w800,
                              color: AppTheme.textDark,
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 4),
                              Text(
                                '$tripsCount course(s) réalisée(s)',
                                style: const TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
                                  color: AppTheme.primaryBlue,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            '${v['immatriculation'] ?? ''} • ${v['type'] ?? ''}${v['couleur'] != null ? ' • ${v['couleur']}' : ''}',
                            style: const TextStyle(
                              fontSize: 12,
                              color: AppTheme.textGrey,
                            ),
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'En acceptant, la protection vocale démarre automatiquement pour vous et le transporteur.',
                        style: TextStyle(
                          fontSize: 12,
                          color: AppTheme.textDark,
                        ),
              ...
              const SizedBox(height: 8),
              const Text(
                'Le transporteur sera notifié : "Vous débutez une nouvelle course"',
                textAlign: TextAlign.center,
