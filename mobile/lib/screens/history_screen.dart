    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : _error != null
              ...
              : _trips.isEmpty
                  ? Center(child: Text(LanguageService.instance.t('no_finished_trip')))
                  : RefreshIndicator(
                      ...
                      child: ListView(
                        ...
                        children: [
                          Text(LanguageService.instance.t('history_trips'), style: TextStyle(fontSize: 26, fontWeight: FontWeight.w800, color: AppTheme.textDark)),
                          Text(LanguageService.instance.t('view_recent_trips'), style: TextStyle(color: AppTheme.textGrey, fontSize: 13)),
    ...
    return Column(
      ...
      children: [
        ...
        ...trips.map((trip) {
          ...
          final badge = trip.statut == 'TERMINE' ? LanguageService.instance.t('terminated') : trip.statut;
