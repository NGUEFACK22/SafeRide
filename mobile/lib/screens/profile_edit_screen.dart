              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(controller: _nom, decoration: const InputDecoration(labelText: 'Nom', filled: true, fillColor: Colors.white), validator: (v) => v == null || v.isEmpty ? 'Requis' : null),
                    const SizedBox(height: 10),
                    TextFormField(controller: _prenom, decoration: const InputDecoration(labelText: 'Prénom', filled: true, fillColor: Colors.white), validator: (v) => v == null || v.isEmpty ? 'Requis' : null),
                    const SizedBox(height: 10),
                    TextFormField(controller: _email, keyboardType: TextInputType.emailAddress, decoration: const InputDecoration(labelText: 'Email', filled: true, fillColor: Colors.white), validator: (v) => v != null && v.contains('@') ? null : 'Email invalide'),
                    const SizedBox(height: 10),
                    TextFormField(controller: _telephone, keyboardType: TextInputType.phone, decoration: const InputDecoration(labelText: 'Téléphone', filled: true, fillColor: Colors.white), validator: (v) => v == null || v.isEmpty ? 'Requis' : null),
                    const SizedBox(height: 20),
                    const Text('Mot de sécurité (SOS vocal)', style: TextStyle(fontWeight: FontWeight.w800, color: AppTheme.textDark)),
                    const SizedBox(height: 6),
                    const Text('Ce mot déclenche l\'alerte SOS vocale (Vosk + ECAPA 3 prises).', style: TextStyle(fontSize: 11, color: AppTheme.textGrey)),
                    const SizedBox(height: 8),
                    TextFormField(controller: _motSecurite, decoration: const InputDecoration(labelText: 'Mot de sécurité', hintText: 'Ex: au secours', prefixIcon: Icon(Icons.mic), filled: true, fillColor: Colors.white), validator: (v) => null),
                    const SizedBox(height: 20),
                    FilledButton(
