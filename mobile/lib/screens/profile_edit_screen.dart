              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 6),
                    Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8), decoration: BoxDecoration(color: AppTheme.lightBlueBadge, borderRadius: BorderRadius.circular(8), border: Border.all(color: AppTheme.lightBlueBorder)), child: Row(children: const [Icon(Icons.info_outline, size: 14, color: AppTheme.primaryBlue), SizedBox(width: 6), Expanded(child: Text('Vos contacts d\'urgence (numéro à appeler) se gèrent aussi depuis Profil > Contacts d\'urgence — un email est requis par contact.', style: TextStyle(fontSize: 11, color: AppTheme.primaryBlue)))])),
