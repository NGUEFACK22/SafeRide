...
class SosAlertMail extends Mailable
{
    ...
    public function build(): self
    {
        ...
        $liveRow = $liveLink === '—'
            ? ''
            : '<tr><td style="border-bottom:1px solid #f0f0f0"><strong>Suivi en direct :</strong></td><td style="border-bottom:1px solid #f0f0f0"><a href="' . $liveLink . '"><strong>Voir le suivi en direct</strong></a><br><span style="color:#666;font-size:12px">' . $liveLink . '</span></td></tr>';
        ...
        $html = '<div style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">'
            ...
            . '<p>' . $salutation . '</p>'
            . "<p><strong>Une alerte SOS vient d'être déclenchée sur SafeRide AI.</strong></p>"
            ...
            . '<tr><td style="border-bottom:1px solid #f0f0f0"><strong>Position GPS :</strong></td><td style="border-bottom:1px solid #f0f0f0">' . $mapAnchor . '</td></tr>'
            . $liveRow
